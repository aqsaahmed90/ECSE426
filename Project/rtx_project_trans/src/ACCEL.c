...
// 	//Writes to 0111 to CTRL_REG3. This value enables the interrupt.
// 	//It is taken from pg 9 of the Tapping application notes.
//   ctrl=0x7;
...
//    
// 	//Set maximum tap length to .5ms. Not really sure how long taps
// 	//last, but this works well enough.
//   ctrl=0x00;
...
angle_data read_Accelerometer(void){
	...
	angle_vals.roll = (atan(returned_vals.z/sqrt(pow(returned_vals.x,2) + pow(returned_vals.y, 2))))*(180/3.14);
