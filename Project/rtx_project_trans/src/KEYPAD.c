 ...
 *
 * @notes Initialize the keypad with columns as outputs and rows as inputs.
 */
...
/**
 * @brief Convert a button to a set of angles.
 * @notes Convert a button to a specified roll and pitch angles, unless the
 *				is not associated with one.
 * @param button: The button pressed.
 * @retval The pitch and roll angles.
 */
